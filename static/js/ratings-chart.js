...
$(".ratings-chart-btn").on("click", (evt) => {
  ...
  $("#patient-content").replaceWith(`<div id="patient-content">
                                     <form class="chart-date-form" data-patient-id="${patientId}">
                                     <label for="chart-date-select">See ratings for previous weeks:</label>
                                     ...
                                     <p>
                                        ...
                                        the rating’s value and the time it was 
                                        posted.
                                     </p>
...
$("body").on("submit", "form.chart-date-form", (evt) => {
  ...
  const searchStartDate = (moment(res.data.search_start_date).format("MMM D, YYYY"));

  $("#chart-div").replaceWith(`<div id="chart-div"><h4>Ratings for week of ${searchStartDate}</h4><p>Hover over a point on the chart to view the rating’s value and the time it was posted.</p><canvas id="ratings-chart" width="800" height="500"></canvas></div>`);
